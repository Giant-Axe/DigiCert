                                        ...
                                        <table>
                                            ...
                                            {this.state.sCertificates.map((certificate, i) =>{
                                                return <tr key={i}>
                                                    ...
                                                    <td><a className="btn-small waves-effect waves-light" type="submit" name="action" href={`https://ipfs.io/ipfs/${certificate.hash_c}`}download>
